...
export default class QuanLyDSPhim extends Component {
  datafilm = [
      {
        maPhim: 1283,
        tenPhim: "Trainwreck",
         ...
         return <div className="col-2 mt-5" key={film.id}>
             <div className="card">
                 ...
                 <div className="card-body">
                     <p style={{height:50}}>{film.tenPhim}</p>
                     <p style={{height:150}}>{film.moTa.length > 100 ? film.moTa.substr(0,100) + '...' : film.moTa}</p>
                 </div>
             </div>
         </div>
     })
  ...
  render() {
    return (
      ...
      >
          <div className="w-100 h-100" style={{backgroundColor:'rgba(0,0,0,.8)'}}>
